...
class MapChangeReceiver implements NativeMapView.StateCallback {
  ...
  public void onWillStartRenderingFrame() {
    if (!onWillStartRenderingFrameList.isEmpty()) {
      for (MapView.OnWillStartRenderingFrameListener onWillStartRenderingFrameListener : onWillStartRenderingFrameList) {
  ...
  public void onDidFinishRenderingFrame(boolean fully) {
    if (!onDidFinishRenderingFrameList.isEmpty()) {
      for (MapView.OnDidFinishRenderingFrameListener onDidFinishRenderingFrameListener : onDidFinishRenderingFrameList) {
        onDidFinishRenderingFrameListener.onDidFinishRenderingFrame(fully);
      }
    }
  }
  ...
  public void onWillStartRenderingMap() {
    if (!onWillStartRenderingMapListenerList.isEmpty()) {
      for (MapView.OnWillStartRenderingMapListener onWillStartRenderingMapListener : onWillStartRenderingMapListenerList) {
  ...
  public void onDidFinishRenderingMap(boolean fully) {
    if (!onDidFinishRenderingMapListenerList.isEmpty()) {
      for (MapView.OnDidFinishRenderingMapListener onDidFinishRenderingMapListener : onDidFinishRenderingMapListenerList) {
        onDidFinishRenderingMapListener.onDidFinishRenderingMap(fully);
      }
    }
  }
  ...
  public void onDidFinishLoadingStyle() {
    if (!onDidFinishLoadingStyleListenerList.isEmpty()) {
      for (MapView.OnDidFinishLoadingStyleListener onDidFinishLoadingStyleListener : onDidFinishLoadingStyleListenerList) {
